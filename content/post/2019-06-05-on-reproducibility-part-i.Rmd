...
The series posts listed below will deal with approaches (of varying complexity) to allow an entire analyses (from raw data to final report/publication) to be reproduced by anyone (with a little bit of computing knowledge) in `R`.
