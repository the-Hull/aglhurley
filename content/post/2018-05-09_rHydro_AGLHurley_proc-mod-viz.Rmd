...
[**the entire tutorial (director's cut) is right here,**](/ext_post/01_rHydro_AGLHurley_proc-mod-viz.html) and you can find the raw document [here](https://github.com/the-Hull/aglhurley/blob/master/static/files/ext_rmd/egu_rhydro_sc/presentation/01_rHydro_AGLHurley_proc-mod-viz.Rmd).
