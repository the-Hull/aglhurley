---
title: "Processing, modelling and vizualising hydrological data in R - Director's Cut"
...
# custom theme
source("../../scripts/src/01_presentation.R")
...
shp_files <- fs::dir_info(path = "../../rdat/GBR_adm",
...
cd3_data <- fs::dir_info("../../rdat/CEH_FEH/",
                         glob = "*.CD3",
                         recursive = T)$path %>%
  map_dfr(read_cd3)
...
What impact does catchment area have on peak flows, and does it differ between countries?
...
## thanks to http://ijlyttle.github.io/ 
